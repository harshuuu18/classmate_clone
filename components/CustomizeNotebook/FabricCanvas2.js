...
function FabricCanvas2({ width = "100px", height = "141px", loadCv, c, canvii, imgURl }) {
    ...
    useEffect(() => {
        ...
        if (Object.keys(loadCv).length > 0) {
            ...
            canvas.loadFromJSON(loadCv, function () {
                ...
                console.log(`setCvData has called first for ${c.id}`)
                setCvData(can)
            ...
            fabric.Image.fromURL("/A4.png", function (img) {
                ...
                if (imgURl) {
                    ...
                    fabric.Image.fromURL(imgURl, function (oImg) {
                        ...
                        console.log(`setCvData has called Second for ${c.id}`)
                ...
                console.log(`setCvData has called Third for ${c.id}`)
